...
<head>
    ...
    <title>Laporkan Barang Temuan - MyPengembalianBarangKu</title>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-primary-100 tracking-wider uppercase">Laporkan Barang Temuan</p>
                    </div>
                </div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-stone-100 p-8">
                ...
                <div class="text-center mb-8 border-b border-stone-100 pb-6">
                    ...
                    <p class="text-stone-500">Isi formulir di bawah dengan lengkap dan jelas</p>
                </div>
                ...
                {{-- Form --}}
                <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data" id="reportForm"
                    class="space-y-6">
                    @csrf
                        ...
                        <p class="text-xs text-stone-400 mt-2">
                            📁 Foto akan disimpan di: <span
                                class="font-mono bg-stone-100 px-2 py-1 rounded">storage/items/<span
                                    id="category-folder">kategori</span>/</span>
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="location_found" id="location_found" value="{{ old('location_found') }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="date_found" id="date_found" value="{{ old('date_found') }}"
                                max="{{ date('Y-m-d') }}"
                                class="w-full px-4 py-3 border border-stone-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all bg-stone-50 focus:bg-white"
                                required>
                        </div>
                        <div>
                            ...
                            <input type="time" name="time_found" id="time_found" value="{{ old('time_found') }}"
                                class="w-full px-4 py-3 border border-stone-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all bg-stone-50 focus:bg-white"
                                required>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div id="upload-prompt">
                                <label for="photo" class="cursor-pointer">
                                    ...
                                    <p class="text-stone-700 font-medium mb-1">Klik untuk upload foto</p>
