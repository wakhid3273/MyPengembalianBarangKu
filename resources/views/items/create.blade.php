            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-white/80">Laporkan Barang Temuan</p>
                    </div>
                </div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="form-container bg-white rounded-2xl shadow-2xl p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Isi formulir di bawah dengan lengkap dan jelas</p>
                </div>
                ...
                <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data" id="reportForm">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            📁 Foto akan disimpan di: <span class="font-mono bg-gray-100 px-2 py-1 rounded">storage/items/<span id="category-folder">kategori</span>/</span>
                        </p>
                    </div>
                        ...
                        <div class="upload-zone border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                            ...
                            <div id="upload-prompt">
                                <label for="photo" class="cursor-pointer">
                                    ...
                                    <p class="text-gray-700 font-medium mb-2">Klik untuk upload foto</p>
