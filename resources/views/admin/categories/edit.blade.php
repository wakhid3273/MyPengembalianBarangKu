...
<head>
    ...
    <title>Edit Kategori - Admin MyPengembalianBarangKu</title>
...
<body class="bg-stone-50 font-sans text-stone-800">
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm border border-stone-100 p-8">
            <h2 class="text-2xl font-sans font-bold text-stone-800 mb-6">Edit Kategori</h2>
            ...
            <form action="{{ route('admin.categories.update', $category->category_id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full rounded-lg border-stone-300 focus:border-primary-500 focus:ring focus:ring-primary-200 transition">{{ old('description', $category->description) }}</textarea>
